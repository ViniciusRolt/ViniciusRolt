...
<div style="display: flex; align-items: flex-start; gap: 50px;">
  ...
  <!-- Tecnologias -->
  <div>
    <h3 style="color:#0000CD;">Tecnologias que tenho conhecimentos!</h3>
  ...
  <!-- Contatos -->
  <div>
    <h3 style="color:#0000CD;">Formas de contato</h3>
    <div>
